...
[^32-bit-machines]: It says it works for 32-bit machines, but the tagging mechanism cannot work generally on 32-bit machines. This trick works on 64-bit machines because the vast majority of 64-bit machines use an address space between 48 and 53 bits, and not the full 64-bits. At best you would have to allocate on 256-byte boundaries to prevent this, not the 4-bytes it states.
